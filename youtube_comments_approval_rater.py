...
"""
Parses through youtube video comments and gives a positive/negative result based on keywords.
"""
...
def get_comments(url):
	html = request.get('https://plus.googleapis.com/u/0/_/widget/render/comments?first_party_property=YOUTUBE&href=' + url)
